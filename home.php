...
<br>
<hr>
<div style="border:line; color:black;" ><center><p>© 2018 M&J(Eduguru) </b><a href="#">Terms </a><a href="#">Policy </a><a href="#">About us </a><b><br><b>Developed by Ajay Kadoula<a href="http://www.uietkuk.org/">(Uiet)</a></b></p></center></div>
			...
			<div  >
				...
				<div class="c-body" >
						<iframe
								...
								width="100%"
								height="300"
								src="https://console.dialogflow.com/api-client/demo/embedded/8e56f8ca-027d-44da-8e59-952e495c0b9e">
						</iframe>
					</div>
 					<form action="post1.php" method="post" enctype="multipart/form-data">
						<div class="c-header">
							<div class="c-h-inner" >
								<ul>
									<li id="chatbot" style="border-right:none; color: rgb(59, 89, 152);"><img src="img/1.png"></img>ChatBot</li>
						...
						<div class="post-show">
									<div class="post-show-inner"><div class="id-img-box" style="margin-left:10px;"><img src="profile_image/'.$row['profile_image'].'"></img></div><br>
										<div class="post-header">
											...
											<div>
                                            <div style="float:left; margin-top:-100; display:block;" ><a href="#"><p></p></a></div>
											<div id="commentview">
											</div><br>
...
$(document).one('click','.comment',function () {
