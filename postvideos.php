...
<body>
	...
	<div class="banner text-center">
	  <div class="container">
			<h1>Post Your<span class="segment-heading">     Lecture online </span> with Eduguru</h1>
			<p>#############################################</p>
		...
		<div class="container">
			<div class="post-ad-form">
			    ...
			    <form id="upload" action="postnotesfunction.php?lecture=" method="POST" enctype="multipart/form-data">
					...
					<select>
					<option style="color:grey;">Select One Free/Paid</option>
					<option>Free</option>
					...
					<input type="text" name="subject"  placeholder="Price">
					<div class="clearfix"></div>
					</div>
				...
				<label>Only video file upload :</label>
					<div class="photos-upload-view">
						...
						<div>
							<input type="file" name="post_lecture" id="fileselect" name="fileselect" multiple="multiple" />
					...
					<div class="clearfix"></div>
						...
						<input type="text" name="mobile" class="phone" placeholder="">
						<div class="clearfix"></div>
    ...
    var avatar = $("#fileselect").val();
    var extension = avatar.split('.').pop().toUpperCase();
    if(avatar.length < 1) {
        avatarok = 0;
    }
    else if (extension!="Mp4",extension!=){
        avatarok = 0;
