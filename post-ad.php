...
<body>
	...
	<div class="banner text-center">
	  <div class="container">
			<h1>Sell or Advertise   <span class="segment-heading">    anything online </span> with Eduguru</h1>
			<p>#############################################</p>
			...
			<div class="post-ad-form">
			    ...
			    <form id="upload" action="post_ad_function.php" method="POST" enctype="multipart/form-data">
					...
					<select name="category" class="">
					  ...
					  <option name="category">Tuition Services</option>
					  <option name="category">Rent Your Books</option>
					  <option name="category">Notes</option>
					  <option name="category">Other</option>
					</select>
